...
export default function Header(){
    return (
        ...
        <NavLink to="projects" className={(({isActive}) => isActive ? "decoration-4 underline underline-offset-8 decoration-orange-500" : "ml-12 hover:text-orange-500 max-sm:ml-6")}>Projects</NavLink>
        </nav>
        </header>
        </>
    )
